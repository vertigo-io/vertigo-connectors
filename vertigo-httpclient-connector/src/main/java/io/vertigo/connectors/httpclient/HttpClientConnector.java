 ...
 *
 * Supports server authentication through a custom trust store, and client authentication (mTLS) through a
 * key store from which a single, explicitly named entry is used as the client certificate.
 *
 * @author npiedeloup
 */
